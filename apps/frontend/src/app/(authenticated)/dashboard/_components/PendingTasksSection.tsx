    ...
    <div className="bg-blue-50 dark:bg-blue-900/20 border-2 border-blue-200 dark:border-blue-800 rounded-lg p-6">
      <div className="flex items-start justify-between mb-3">
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">{search.location}</p>
        </div>
      ...
      <div className="mb-2">
        ...
        <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2 overflow-hidden">
          <div className="bg-blue-600 h-2 animate-pulse" style={{ width: '100%' }} />
        </div>
      </div>
      <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
        This usually takes 5-10 minutes. The page will auto-refresh when complete via real-time
        updates.
      </p>
    </div>
  );
